...
import { AlertTriangle, Heart, Phone, ShieldCheck, MapPin, PhoneCall } from 'lucide-react';

export default function SafetyAlertCard({ type, supportCard, action, onOpenFacilities, onOpenEscalation }) {
  if (type === 'danger_sign') {
    return (
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              {action && (
                <button
                  ...
                  className="flex items-center gap-2 bg-red-500 hover:bg-red-400 text-slate-950 font-bold text-xs px-3.5 py-2 rounded-lg shadow-lg transition"
                >
              ...
              {onOpenEscalation && (
                <button
                  ...
                  className="flex items-center gap-1.5 bg-slate-900 hover:bg-slate-800 text-amber-300 border border-amber-500/50 font-bold text-xs px-3.5 py-2 rounded-lg transition"
                >
            ...
            <div className="mt-3 flex flex-wrap items-center gap-2">
              {action && (
                <button
                  ...
                  className="flex items-center gap-1.5 bg-purple-600 hover:bg-purple-500 text-white font-semibold text-xs px-3.5 py-1.5 rounded-lg transition"
                >
              ...
              {onOpenEscalation && (
                <button
                  onClick={onOpenEscalation}
                  className="flex items-center gap-1.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs px-3.5 py-1.5 rounded-lg transition shadow-md shadow-amber-500/20"
                >
            ...
            <div className="mt-2.5 flex flex-wrap items-center gap-2">
              {action && (
                <button
                  ...
                  className="flex items-center gap-1.5 bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-[11px] px-3 py-1.5 rounded-lg transition"
                >
                  <MapPin className="w-3.5 h-3.5" />
              ...
              {onOpenEscalation && (
                <button
                  onClick={onOpenEscalation}
                  className="flex items-center gap-1.5 bg-slate-800 hover:bg-slate-750 text-amber-300 border border-amber-500/40 font-bold text-[11px] px-3 py-1.5 rounded-lg transition"
                >
                  <PhoneCall className="w-3.5 h-3.5 text-amber-400" />
                  <span>Talk to someone now</span>
                </button>
